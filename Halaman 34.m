%1.Didefinisikan vektor dan matriks berikut ini di dalam MATLAB:
...
%3. Hitunglah :
 ...
 >> size(vektor_1), size(vektor_2), size(matriks)
   ...
   %b. Masing-masing jumlah elemen vektor/matriks pada soal no.1 dan no.2
   %diatas
 >> prod(size(vektor_1)), ...
...
%5. Buatlah vektor berukuran 100 berisi bilangan acak gaussian dengan mean
%= 1 dan variansi =0,2
...
%8. Buatlah matriks N yang berisi kolom pertama hingga keempat dan matriks
